...
namespace AdoNetExercise
{
    public static class SqlQueries
    {
        ...
        public const string GetByVillainIdHisMinions =
        ...
        public const string InsertIntoVillains =
        ...
        public const string InsertIntoMinions =
            @"INSERT INTO Minions (Name, Age, TownId) VALUES (@name, @age, @townId)";

        public const string InsertIntoMinionsVillains =
